...
if(c.dataset.mode==='roster'){/* day roster: rows are agents, columns are the 24 hours of one day; fills like a clock over about 16 s, rests 10 s, then a new day (slower on purpose: it is background, not a show). green vouched, amber missed or unproven, red failed */
